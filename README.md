...
mov ASCII,result_high

rcall print

mov ASCII,result_low
...
ldi ZL,low((2*OLED_INIT_BYTES)+0x4000)

ldi ZH,high((2*OLED_INIT_BYTES)+0x4000)
...
ldi array_byte,0x20           ;hex value of first ASCII character in font array
...
;CLEAR_OLED    r20/r19 registers array_byte/array_length used  writes 128*4 0 to OLED
